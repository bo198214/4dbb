...
//	private static String getKeyText(int keyCode,int modifiers) {
...
//	
	private class KeyTableModel extends AbstractTableModel {
		private static final long serialVersionUID = 2496223147905219178L;
	...
	private JTable getJTable() {
		if (jTable == null) {
			jTable = new JTable(new KeyTableModel());
		}
		return jTable;
	}
