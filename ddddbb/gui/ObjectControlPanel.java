...
public class ObjectControlPanel extends DPanel {
	...
	public ObjectControlPanel(
		...
		{
			nLeft = new DArrowButton(SwingConstants.WEST, brightness);
		...
		{
			nRight = new DArrowButton(SwingConstants.EAST, brightness);
		...
		{
			nPos = new DLabel(30,16, brightness);
		...
		{
			xzLeftRot = new DArrowButton(SwingConstants.WEST, brightness);;
		...
		{
			xzRightRot = new DArrowButton(SwingConstants.EAST, brightness);;
		...
		{
			ywLeftRot = new DArrowButton(SwingConstants.WEST, brightness);;
		...
		{
			ywRightRot = new DArrowButton(SwingConstants.EAST, brightness);
		...
		scene.compounds.addChangeListener(new MyChangeListener() {
			@Override
